...
const root=new URL('./',import.meta.url),packet=new URL('tape-evidence/',root);fs.mkdirSync(packet,{recursive:true});
const read=p=>JSON.parse(fs.readFileSync(new URL(p,root),'utf8'));
const c=read('notebook-evidence/home.json').contracts,prior=read('behavior-updates/2026-09-16T054047Z/evidence/target.json');
const raw=[];let id=0;
